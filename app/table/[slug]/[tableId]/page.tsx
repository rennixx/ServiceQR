...
export default async function TablePage({ params }: TablePageProps) {
  ...
  // Fetch table and restaurant data
  const result = await getTableBySlugAndId(slug, tableId);
